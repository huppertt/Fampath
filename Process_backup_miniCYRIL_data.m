...
[file, path] = uigetfile('C:\Users\columbia\Documents\miniCYRIL at Columbia\Back Up NIRS Data\*.txt','Select back up file');
s_and_time = load([path file]);

filename = ['C:\Users\columbia\Documents\miniCYRIL at Columbia\Processed NIRS Data\' erase(file,'.txt') ' processed.mat'];
...
wl_cal = load('wavelengths_Columbia.mat');
...
%     end
    ...
    clearvars -except Conc Wavelengths Time Spectra Settings Diff filename 
    
    save(filename,'Spectra','Conc','Settings','Wavelengths','Time','Diff')
